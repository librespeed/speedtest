...
## Docker
A docker image is available on the [Docker Hub](https://registry.hub.docker.com/r/adolfintel/speedtest), see [doc_docker](doc_docker.md) for more info about it
